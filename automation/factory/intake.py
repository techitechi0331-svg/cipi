...
def build_evidence_record(bundle: dict[str, Any]) -> dict[str, Any]:
    ...
    record: dict[str, Any] = {
        ...
        "factory_revision": bundle["factory_revision"],
...
def validate_evidence_record(record: dict[str, Any]) -> None:
    required = {
        ...
        "claim", "contract_sha256", "generated_source_sha256", "factory_revision",
        "dsp_source_revision", "failure_class", "raw_audio_persisted",

...
class ContractTests(unittest.TestCase):
    ...
    def test_golden_project_files_exist(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertIn("\n        0.0f,\n", processor)
            self.assertIn('AudioParameterFloatAttributes().withLabel("dB")', processor)
            processor_header = (out / "Source" / "PluginProcessor.h").read_text(encoding="utf-8")
            self.assertIn('juce::String("Default")', processor_header)
